...
import LikeRecommendationSidebar from '../components/LikeRecommendationSidebar';
import {
  getUser,
  updateUser,
  getUserLikes,
                        ...
                        <div className="rounded-lg border border-[#c5cedd] bg-[#fafbfc] p-5">
                          ...
                          <div className="space-y-5">
                            {Object.entries(INTEREST_CATEGORIES).map(([category, items]) => (
                              <div key={category}>
                                <h3 className="mb-2.5 text-[12px] font-bold tracking-wider text-[#7a8497] uppercase">
                                  {category}
                                </h3>
                  ...
                  <div className="px-4 py-3">
                    <div className="mb-3 border-b border-[#c5cedd] pb-3">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[11px] text-[#5d6676]">
                    ...
                    <div>
                      <div className="flex flex-col gap-2">
                        <div className="flex items-center justify-between">
                          <p className="text-[13px] font-medium text-[#1e232e]">마감 임박 알림</p>
                          {deadlineAlert !== null ? (
                            <Switch
